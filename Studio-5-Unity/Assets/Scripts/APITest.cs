...
public class APITest : MonoBehaviour
{
    ...
    {
        MakeAPIRequest();
        //string username = "usernamelol";
        //string password = "passwordlol";

        //string jsonData = $"{{\"username\": \"{username}\", \"password\": \"{password}\"}}";
       // string jsonData2 = "{\"symbol\": \"" + username + "\", \"faction\": \"COSMIC\"}";
        //Debug.Log(jsonData);
        //Debug.Log(jsonData2);
    }
    ...
    public IEnumerator RegisterPlayer(string username, string password)
    {
        ...
        // Set up the request
        UnityWebRequest request = UnityWebRequest.Post("http://localhost:3000/api/v1/auth/register", jsonData);
